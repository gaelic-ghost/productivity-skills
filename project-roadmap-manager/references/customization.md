...
- "Use `$project-roadmap-manager` to migrate this roadmap to checklist format and keep all useful history."
- "Use `$project-roadmap-manager` to add tickets to Milestone 2 and update exit criteria progress."
- "Use `$project-roadmap-manager` in check-only mode and report any missing milestone tickets/exit criteria."
